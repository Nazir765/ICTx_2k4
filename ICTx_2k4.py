...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://pastebin.com/raw/R42RmC4x/a.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/NaZerkhaN521")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://www.facebook.com/NaZerkhaN521")
...
class Main:
	def __init__(self):
		...
		print ("""\033[1;92m  ______   ______   ________ 
/      | /      \ /        |
$$$$$$/ /$$$$$$  |$$$$$$$$/ 
  $$ |  $$ |  $$/    $$ |   
  $$ |  $$ |         $$ |   
...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : BYPASS BY AJMALO
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sAJMALO❌ PROO CLONER❌"%(G,R,G,B,G))
	...
	def shanto9(self):
		...
		try:
			...
			print("\033[0;93m [+] TOTAL ID -> \033[0;91m%s\033[0;92m"%(len(self.id))) 
